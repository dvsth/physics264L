...
sun = 4000:20:7000;
metal = 1000:10:2000;
alberio_bright = 1500:20:4500;
alberio_faint = 8000:20:18000;
%convenience is a h*** of a d***
current_object = alberio_faint;

%Calibration ratios
R_calibration = 1;
G_calibration = 0.8788;
B_calibration = 0.5530;
...
%% Section 2: StarStuff
%---------------------%
%For Albireo Faint Star:
[red,green,blue,image] = GetRAWDATAandIMAGE('Albireo.dng');

%Region of interest for Faint star:
ROI_red = red(833:837,1303:1307);
ROI_blue = blue(833:837,1303:1307);
ROI_green = green(833:837,1303:1307);


%% Section 3: Calculate RGB channel intensity ratios
...
%% Section 4: Calculate and plot theoretical intensity ratios
...
%% Section 5: Overlay theoretical plot with experimental data
...
%% Section 6 (Extra): Plot theoretical blackbody spectra for given temperature ranges
% for a = current_object
% hold all
% [b_1, int_b] = I_Band(a, Tr_blue);
% [r_1, int_r] = I_Band(a, Tr_red);

...
sun = 4000:20:7000;
metal = 1000:10:2000;
alberio_bright = 3000:10:5000;
alberio_faint = 2000:100:15000;
%convenience is a h*** of a d***
current_object = alberio_bright;
...
%% Section 2: StarStuff
%---------------------%
%For Albireo Bright Star:
[red,green,blue,image] = GetRAWDATAandIMAGE('Albireo.dng');

%Region of interest for brighter star:
ROI_red = red(799:803,1348:1352);
ROI_blue = blue(799:803,1348:1352);
ROI_green = green(799:803,1348:1352);
...
%% Section 6: Plot theoretical blackbody spectra for given temperature ranges
for a = current_object
hold all
[b_1, int_b] = I_Band(a, Tr_blue);
[r_1, int_r] = I_Band(a, Tr_red);
